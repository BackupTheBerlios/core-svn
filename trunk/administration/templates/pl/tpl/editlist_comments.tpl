...
<tfoot>
    ...
    <tr>
        <td colspan="7"><input
            type="submit" name="sub_delete" value="Usuñ zaznaczone komentarze"
            onclick="return askChecked('Czy na pewno chcesz usun±æ zaznaczone komentarze?', 'selected_comments[]')" /></td>
    </tr>
</tfoot>
<tbody>

<div id="left">
<img src="templates/{LANG}/images/main.gif" width="14" height="14" align="middle" hspace="2"><b>Strony serwisu - dodaj kolejny podstronę</b><br /><br />

<form action="main.php?p=3" enctype="multipart/form-data" method="post" id="formPage">
<table width="100%" align="left">
    <!-- IFDEF: PAGE_PREVIEW -->
    <tr>
        <td class="form">Podgląd:&nbsp;</td>
    ...
    <!-- ENDIF -->
    <tr>
		<td class="form" width="100"><label for="title">Tytuł strony:</label></td>
		<td class="form" colspan="2"><input type="text" name="title" id="title" size="30" maxlength="255" value="{P_TITLE}" /></td>
	</tr>
	<tr>
		<td class="form">&nbsp;</td>
		<td class="form" colspan="2">
		<input type="text" name="helpline" id="helpline" value="Rada: Style mogą być stosowane szybko do zaznaczonego tekstu" disabled="disabled" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="form"><label for="canvas">Treść strony:</label></td>
		<td class="form" colspan="2">
		<textarea class="note_textarea" name="text" id="canvas">{P_TEXT}</textarea>
		</td>
	</tr>
	<tr>
		<td class="form"><label for="file">Załącz zdjęcie:</label></td>
	...
	<tr>
		...
		<select class="category_form" name="category_id" id="categoryId">
			<option> -- strona nadrzędna -- </option>
	...
	<tr>
		...
		<td class="form" colspan="2">
            ...
            <label><input class="radio" type="radio" name="separately" value="1" />- tak (dotyczy <strong>tylko</strong> stron nadrzędnych)</label>
        </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="form center" colspan="2">
            <input type="submit" tabindex="5" name="preview" value="Podgląd strony" />

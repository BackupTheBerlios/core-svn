<div id="left">
<h2><img src="templates/{LANG}/images/main.gif">Aktualności - edycja wpisów</h2>
...
<tfoot>
    ...
    <tr>
        <td class="addinfo" colspan="7">
            <input type="submit" name="sub_status" value="Przełącz status zaznaczonych" />
            <input type="submit" name="sub_delete" value="Usuń zaznaczone"  onclick="return askChecked('Czy na pewno chcesz usunąć zaznaczone wpisy?', 'selected_notes[]')" />
        </td>
    </tr>
</tfoot>
<tbody>

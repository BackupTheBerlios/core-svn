...
<tfoot>
	<tr>
		<td class="addinfo" colspan="6"><input
            type="submit" name="sub_delete" value="Usuń zaznaczone linki"
            onclick="return askChecked('Czy na pewno chcesz usunąć zaznaczone linki?', 'selected_links[]')" /></td>
	</tr>
</tfoot>
<tbody>
    ...
    <tr>
		...
		<td class="{ID_CLASS} center"><a href="main.php?p=12&amp;action=delete&amp;id={LINK_ID}">Usuń</a></td>
	</tr>

...
<table width="100%" align="left">
	...
	<tr>
		...
		<td class="form" colspan="2">
            <input class="radio" type="radio" name="separately" value="0" {SEPARATELY_NO} />- nie&nbsp;
            <input class="radio" type="radio" name="separately" value="1" {SEPARATELY_YES} />- tak (dotyczy <strong>tylko</strong> stron nadrzêdnych)
        </td>
	</tr>
	<tr>

...
<div id="left">
<h2><img src="templates/{LANG}/images/main.gif">Aktualności - edycja wpisu</h2>
...
<table width="100%" align="left">
	...
	<tr>
		<td class="form"><label for="canvas">Treść wpisu:</label></td>
	...
	<tr>
		...
		<td class="form center" colspan="2">
            ...
            <input type="submit" name="sub_preview" value="Podgląd treści" tabindex="5" />

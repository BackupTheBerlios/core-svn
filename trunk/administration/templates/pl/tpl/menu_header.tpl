<ul>
	<li {MAIN_CURRENT}><a href="main.php">Strona Główna</a></li>
	<li {NEWS_CURRENT}><a href="main.php?p=1">Aktualności</a></li>
	...
	<li {USERS_CURRENT}><a href="main.php?p=7">Użytkownicy</a></li>

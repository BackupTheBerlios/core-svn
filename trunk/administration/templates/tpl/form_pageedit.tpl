...
<table width="100%" align="left">
	...
	<tr>
      <td colspan="2" class="align_right"><img src="layout/arrow_blue.gif" alt="Core | CMS" align="middle" height="5" hspace="5" vspace="2" width="5" /><a href="#" onclick="document.getElementById('formPage').submit()">zmodyfikuj wpis</a></td>
	</tr>
</table>
</form>

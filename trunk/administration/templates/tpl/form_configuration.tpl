...
<form enctype="multipart/form-data" method="post" action="add,10,action.html" id="formConfig">
<table width="100%" align="left">
	...
	<tr>
      <td width="364" align="left" valign="top" colspan="2"><br /><a href="#" onclick="document.getElementById('formConfig').submit()">zapisz ustawienia</a></td>
	</tr>
</table>
</form>

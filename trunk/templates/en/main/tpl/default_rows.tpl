...
<!-- IFDEF: IMAGE_EXIST -->
    ...
    <div id="image">
	   ...
	   <a href="javascript:foto('{SITE_ROOT}/{PHOTO_LINK}', {WIDTH}, {HEIGHT});">View</a> in 
	   new window.
    </div>
    <!-- ENDIF -->
<!-- ELSE -->
...
<!-- IFDEF: COMMENTS_ALLOW -->
    <!-- IFDEF: COMMENTS -->
    <a class="comments" href="{SITE_ROOT}/{COMMENTS_LINK}">comments ({COMMENTS})</a>
    <!-- ELSE -->
    <a class="comments" href="{SITE_ROOT}/{COMMENTS_LINK}">leave a word</a>
    <!-- ENDIF -->
<!-- ELSE -->

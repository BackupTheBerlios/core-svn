...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		<title>./dev-log {lektura wcale nie obowiązkowa}</title>
...
<div id="main">
	...
	<div id="right">
		...
		<div class="right">
			<a href="javascript:text_resize('content',-1)"><img alt="Pomniejszenie tekstu" src="layout/new/minus.jpg" width="12" height="12" /></a>
			<a href="javascript:text_resize('content',1)"><img alt="Powiększenie tekstu" src="layout/new/plus.jpg" width="12" height="12" /></a>
		</div>

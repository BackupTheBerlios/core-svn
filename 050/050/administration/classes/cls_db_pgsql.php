<?php
// $Id: cls_db_pgsql.php 1128 2005-08-03 22:16:55Z mysz $
...
class DB_Sql {
	...
	var $Auto_Free     = 0; # Set this to 1 for automatic pg_freeresult on last record.
	...
	function lock($table, $mode = "write") {
	    $result = ($mode == "write") ? pg_Exec($this->Link_ID, "lock table $table") : 1;
	    return $result;
	}

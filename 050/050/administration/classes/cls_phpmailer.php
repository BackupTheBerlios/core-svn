<?php
// $Id: cls_phpmailer.php 1128 2005-08-03 22:16:55Z mysz $

class PHPMailer {
	
	var $Priority			= 3;				// priorytet maila (1 = wysoki, 3 = Normalny, 5 = Niski)
	var $CharSet			= "iso-8859-2";		// kodowanie znaków diaktrycznych
	var $ContentType		= "text/plain"; 	// Content-type wiadomo¶ci
    var $Encoding			= "8bit";			// typ encoding (8bit, 7bit, binary, base 64, quoted-printable)
    
    var $ErrorInfo			= "";				// wiadomo¶ci b³êdów
    
    var $From				= "root@localhost";	// pole From
    var $FromName			= "Root User";		// pole u¿ytkownik From
    var $Sender				= "";				// nadawca
    var $Subject			= "";				// temat wiadomo¶ci
    var $Body				= "";
    
    var $AltBody			= "";
    var $WordWrap			= 0;
    
    var $Mailer				= "mail";				// metoda wysy³ania mail'a (mail, sendmail, smtp)
    var $Sendmail			= "/usr/sbin/sendmail";	// ¶cie¿ka do programu sendmail
    
    var $PluginDir			= "";
    var $Version			= "1.0RC1a";			// phpMailer version
	...
	var $Host				= "localhost";		// smtp host (na przyk³ad: "smtp1.example.com:25;smtp2.example.com")
	var $Port				= 25;
	var $Helo				= "";
	
	var $SMTPAuth			= false;			// autoryzacja smtp
	var $Username			= "";
	var $Password			= "";
	var $Timeout			= 10;
	var $SMTPDebug			= false;
	...
	// ustawia typ wiadomo¶ci na text/html
    ...
    // ustawia wysy³anie maili u¿ywaj±c smtp
    function IsSMTP() {
    ...
    // ustawia wysy³anie mail'i u¿ywaj±c funkcji mail() w PHP
    function IsMail() {
    ...
    function Send() {
    	...
    	$this->error_count = 0; // resetowanie b³êdów
    	$this->SetMessageType();
    ...
    function CreateHeader() {
        ...
        $result .= $this->HeaderLine("X-Mailer", "dev.mailer - version " . $this->Version);

...
<div id="left">
<h2><img src="templates/{LANG}/images/main.gif"> Aktualności - dodaj kolejny wpis</h2>
...
<table width="100%" align="left">
	...
	<tr>
		...
		<td class="form" colspan="2"><input
            ...
            value="Rada: Style mogą być stosowane szybko do zaznaczonego tekstu" disabled="disabled" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="form center" colspan="2">
            <input type="submit" name="sub_preview" tabindex="5" value="Podgląd treści" />

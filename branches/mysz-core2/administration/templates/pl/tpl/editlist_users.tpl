<div id="left">
<img src="templates/{LANG}/images/main.gif" width="14" height="14" align="middle" hspace="2"><b>Użytkownicy - edycja/usuwanie</b><br /><br />
...
<tbody>
    ...
    <tr>
		...
		<td class="{ID_CLASS} center"><a href="main.php?p=13&amp;action=delete&amp;id={USER_ID}">Usuń</a></td>
	</tr>

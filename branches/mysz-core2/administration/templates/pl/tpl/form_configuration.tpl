...
<table width="100%" align="left">
	...
	<tr>
		<td>Przyjazne linki (wymaga modułu <strong>mod_rewrite</strong> na serwerze):</td>
		<td>
	...
	<tr>
		<td>Nowości CORE RSS na stronie głównej panelu:</td>
		<td>
    ...
    <tr>
      <td><label for="dateFormat">Format daty (<a href="http://php.net/date">szczegóły</a>):</label></td>
    ...
    <tr>
      ...
      <td><select name="start_page" id="startPage" class="category_form">
          ...
          <optgroup label="kategorie aktualności">
    ...
    <tr>
		<td><label for="language">Język:</label></td>

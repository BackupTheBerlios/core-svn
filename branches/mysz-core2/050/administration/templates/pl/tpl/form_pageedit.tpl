...
<table width="100%" align="left">
    ...
    <!-- ENDIF -->
	<tr>
		<td class="form" width="100"><label for="title">Tytuł wpisu:</label></td>
	...
	<tr>
		...
		<td class="form" colspan="2">
            ...
            <label><input class="radio" type="radio" name="separately" id="separately" value="1" {SEPARATELY_YES} />- tak (dotyczy <strong>tylko</strong> stron nadrzędnych)</label>
        </td>
	</tr>
	<tr>
